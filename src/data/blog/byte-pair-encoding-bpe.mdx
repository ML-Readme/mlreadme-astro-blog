...
<a
	name="Byte-Pair Encoding tokenization - Hugging Face NLP Course"
...
href = 'https://huggingface.co/datasets/jeremygf/domains-app-alpha/resolve/main/app.txt.gz'
file_path = dl_manager.download(href)
```
...
<a
	name="transformers/projects/domains/preprocess.ipynb at main · jgeofil/transformers"
	href="https://github.com/jgeofil/transformers/blob/main/projects/domains/preprocess.ipynb"
/>
